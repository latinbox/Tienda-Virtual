...
<div class="col-md-3 col-sm-6"><!-- col-md-3 col-sm-6 Inicio -->
<h4> Categoría de productos Top </h4>
<ul><!-- ul Inicio -->
...
while ($row_p_cats = mysqli_fetch_array($run_p_cats)) {
	...
	echo "<li> <a href='shop.php?p_cat=$p_cat_id'> $p_cat_titulo </a> </li>";
}
...
<a href="contacto.php">Ir to Contáctanos page</a>
<hr class="hidden-md hidden-lg">
</div><!-- col-md-3 col-sm-6 Fin -->
<div class="col-md-3 col-sm-6"><!-- col-md-3 col-sm-6 Inicio -->
<h4>Noticias
...
<form action="https://feedburner.google.com/fb/a/mailverify" method="post" target="popupwindow" onsubmit="window.open('https://feedburner.google.com/fb/a/mailverify?uri=rutsita_store', 'popupwindow', 'scrollbars=yes,width=550,height=520');return true"><!-- form Inicio -->
...
<div class="col-md-6" ><!-- col-md-6 Inicio -->
<p class="pull-right" >
Desarrollado por <a href="http://www.camru-store.cl" >tienda-camru.cl</a>
</p>
</div><!-- col-md-6 Fin -->
</div><!-- container Fin -->
</div><!-- copyright Fin -->
